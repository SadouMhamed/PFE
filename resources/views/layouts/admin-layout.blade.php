                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-nav-link :href="route('admin.dashboard_admin')" :active="request()->routeIs('admin.dashboard_admin')">
                                {{ __('Dashboard') }}
                            </x-nav-link>
                            <x-nav-link :href="route('techniciens.index')" :active="request()->routeIs('techniciens.*')">
                                {{ __('Techniciens') }}
                            </x-nav-link>
                            <x-nav-link :href="route('bureau-accounts.index')" :active="request()->routeIs('bureau-accounts.*')">
                                {{ __('Bureaux de Poste') }}
                            </x-nav-link>
                        </div>
                    </div>
